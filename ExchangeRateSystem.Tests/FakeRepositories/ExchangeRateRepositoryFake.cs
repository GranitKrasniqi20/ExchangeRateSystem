...
namespace ExchangeRateSystem.Tests.FakeRepositories
{
    ...
    {
        public static List<ExchangeRate> exchangeRatesFakeList;
        ...
        public ExchangeRateRepositoryFake()
        {
            ...
            {
                exchangeRatesFakeList = new List<ExchangeRate>();
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 1, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 1, DateInserted = DateTime.Now.AddMinutes(-20) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 2, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667534567", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 2, DateInserted = DateTime.Now.AddMinutes(-18) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 3, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667543256", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 3, DateInserted = DateTime.Now.AddMinutes(-15) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 4, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 1, DateInserted = DateTime.Now.AddMinutes(-12) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 5, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 3, DateInserted = DateTime.Now.AddMinutes(-10) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 6, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 1, DateInserted = DateTime.Now.AddMinutes(-8) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 7, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 2, DateInserted = DateTime.Now.AddMinutes(-5) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 8, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 1, DateInserted = DateTime.Now.AddMinutes(-2) });
                exchangeRatesFakeList.Add(new ExchangeRate { Id = 9, Date = DateTime.Now.AddMinutes(-1), Success = true, Result = (decimal)100.1, Rate = (decimal)0.2, TimeStamp = "1667518023", Amount = (decimal)78.34, CurrencyCodeFrom = "eur", CurrencyCodeTo = "usd", UserId = 1, DateInserted = DateTime.Now.AddMinutes(-0) });
            }
            currentUserId = 1;
        }
        public List<ExchangeRate> ExchangeRatesByUserId(int userId)
        {
            var list = exchangeRatesFakeList.Where(x => x.UserId == userId).ToList();
            return list;
        }
        ...
        {
            var exchangeRates = ExchangeRatesByUserId(currentUserId).Where(a => a.DateInserted >= DateTime.Now.AddHours(-1)).ToList();
